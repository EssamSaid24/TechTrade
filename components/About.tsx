...
const AboutUsSection: React.FC = () => {
    return (
        <div className="relative h-full bg-gray-100">
            ...
            {/* <div
                className="relative px-20 py-16 bg-cover bg-center"
                style={{
            ...
            >
                ...
                <h1 className="relative text-white text-5xl font-bold ">About us</h1>

            </div> */}

            {/* Content Section */}
            <div className="px-6 lg:px-20 py-12 flex flex-col lg:flex-row items-center gap-10">
                {/* Left Text Content */}
                <div className="lg:w-1/2 text-center lg:text-left">
                    <h2 className="text-green-600 text-3xl font-bold mb-4">WHO WE ARE</h2>
                    <p className="text-gray-700 text-justify text-lg leading-relaxed">
                        ...
                        most trusted brands only what keeps our name trustworthy in the
                        Egyptian market. Cooperating with factories and manufacturers round
                        the clock with 24/7 support, we are most pleased to offer you
